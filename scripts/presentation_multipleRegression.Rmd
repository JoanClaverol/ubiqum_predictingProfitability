...
Profit_category %>%
  ...
  ggplot(aes(x = reorder(ProductType, Total_Profits))) +
    ...
    labs(title = "Blackwell overview",
         subtitle = "Total Profits ($) vs Total Volume (items)") +
...
## 3rd pre-process: outliers detection of stars variables {.flexbox .vcenter}
...
## 3rd error check: errors visualization linear regression {.flexbox .vcenter}
